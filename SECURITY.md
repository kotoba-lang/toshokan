...
toshokan harvests **public** bibliographic metadata from national library
catalogues and preserves it read-only. The realistic risks are therefore
narrow: harvesting something that was not public, retaining personal data that
arrived incidentally, and the supply chain of the harvest pipeline itself.

Out of scope: the upstream catalogues. Report defects in their services to
them.
